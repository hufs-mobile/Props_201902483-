...
const App = () => {
  ...
  //const flexDirection = ['row', 'row-revers', 'column', 'column-reverse']
    ...
    <ScrollView style={[styles.container]}>
      <View style = {[styles.controlSpace]}>
        <View style={[styles.buttonView]}>
          ...
          onPress={() => console.log('Click CHANGE FLEX EIRECTION')}
          />
        </View>
        <View style={[styles.buttonView]}>
          <Button title="CHANGE JUSTIFY CONTENT"
          onPress={() => console.log('Click CHANGE JUSTIFY CONTENT')} 
          />
        </View>
        <View style={[styles.buttonView]}>
          <Button title="CHANGE ALIGN ITEMS"
          onPress={() => console.log('Click CHANGE ALIGN ITEMS')} 
          />
        </View>
        <View style={[styles.buttonView]}>
          <Button title="CHANGE DIRECTION" 
          onPress={() => console.log('Click CHANGE DIRECTION')}
          />
        </View>
        <View style={[styles.buttonView]}>
          <Button title="CHAGE FLEX WRAP" 
          onPress={() => console.log('Click CHAGE FLEX WRAP')}
          />
        </View>
        <View style={[styles.buttonView]}>
          <Button title="ADD SQUARE"
          onPress={() => console.log('Click ADD SQUARE')} 
          />
        </View>
        <View style={[styles.buttonView]}>
          <Button title="DELETE SQUARE" 
          onPress={() => console.log('Click DELETE SQUARE')}
          />
        </View>
      </View>
